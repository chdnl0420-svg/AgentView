...
function QueuedBubble({ item, onRemove }: { item: QueuedPrompt; onRemove: () => void }) {
...
// lives in the header meta-row; the popup panel below it renders the
// breakdown (input/output tokens + model). Matches the compact dial
// look from the Claude Code desktop status bar.
function ContextDonut({ percent }: { percent: number }) {
