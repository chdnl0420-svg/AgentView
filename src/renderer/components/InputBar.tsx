...
const PERMS: Array<{ value: PermissionMode; label: string; hint: string }> = [
...
const LAST_PERM_KEY = 'lastPermissionMode';
const DEFAULT_PERM: PermissionMode = 'acceptEdits';
function loadLastPerm(): PermissionMode {
